...
Websoft9 MySQL stack is an easy to install and easy to use open source Web 
Platform. It combines leading open source projects, such as MySQL


2. COMPONENTS and Version

Websoft9 MySQL stack ships with the following software versions:

********
- MySQL 5.5.58 or MySQL 5.6.43 or MySQL5.7.25
